...
public class SingleJointedArmCoeffs {
  public static StateSpacePlantCoeffs<N2, N1, N1>
    makeSingleJointedArmPlantCoeffs() {
    Matrix<N2, N2> A = MatrixUtils.mat(Nat.N2(), Nat.N2()).fill(1.0, 0.005049987902346862, 0.0, 0.9999952088540683);
    Matrix<N2, N1> B = MatrixUtils.mat(Nat.N2(), Nat.N1()).fill(1.1444063060619785e-06, 0.0004532298583066335);
  ...
  public static StateSpaceControllerCoeffs<N2, N1, N1>
    ...
    Matrix<N1, N2> K = MatrixUtils.mat(Nat.N1(), Nat.N2()).fill(659.4457876860411, 179.11558938712352);
    Matrix<N1, N2> Kff = MatrixUtils.mat(Nat.N1(), Nat.N2()).fill(0.5390980036447967, 8.538202281633405);
  ...
  public static StateSpaceObserverCoeffs<N2, N1, N1>
    ...
    Matrix<N2, N1> K = MatrixUtils.mat(Nat.N2(), Nat.N1()).fill(0.8033915976431203, 7.738121910642457);

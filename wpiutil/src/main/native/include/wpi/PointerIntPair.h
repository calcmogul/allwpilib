...
#ifndef WPIUTIL_WPI_POINTERINTPAIR_H_
#define WPIUTIL_WPI_POINTERINTPAIR_H_
...
struct PointerLikeTypeTraits<
  ...
  static inline void* getAsVoidPointer(
      const PointerIntPair<PointerTy, IntBits, IntType>& P) {
    return P.getOpaqueValue();
  }

  static inline PointerIntPair<PointerTy, IntBits, IntType> getFromVoidPointer(
      void* P) {
...
template <size_t I, typename PointerTy, unsigned IntBits, typename IntType,
          typename PtrTraits, typename Info>
decltype(auto) get(
    const PointerIntPair<PointerTy, IntBits, IntType, PtrTraits, Info>& Pair) {
  static_assert(I < 2);
  if constexpr (I == 0)
...
#endif  // WPIUTIL_WPI_POINTERINTPAIR_H_

...
template <typename T, typename small_vector, typename Alloc>
concept DefaultInsertable = !concepts::Complete<T> ||
                            concepts::DefaultInsertable<T, small_vector, Alloc>;

template <typename T, typename small_vector, typename Alloc>
concept MoveInsertable =
    !concepts::Complete<T> || concepts::MoveInsertable<T, small_vector, Alloc>;

template <typename T, typename small_vector, typename Alloc>
concept CopyInsertable =
    !concepts::Complete<T> || concepts::CopyInsertable<T, small_vector, Alloc>;

template <typename T, typename small_vector, typename Alloc>
concept Erasable =
    !concepts::Complete<T> || concepts::Erasable<T, small_vector, Alloc>;

template <typename T, typename small_vector, typename Alloc, typename... Args>
concept EmplaceConstructible =
    !concepts::Complete<T> ||
    concepts::EmplaceConstructible<T, small_vector, Alloc, Args...>;

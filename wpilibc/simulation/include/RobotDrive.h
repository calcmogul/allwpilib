 ...
 * motor standard
 * drive trains are supported. In the future other drive types like swerve and
 * meccanum might
 * be implemented. Motor channel numbers are passed supplied on creation of the
 * class. Those are
 * used for either the Drive function (intended for hand created drive code,
 * such as autonomous)

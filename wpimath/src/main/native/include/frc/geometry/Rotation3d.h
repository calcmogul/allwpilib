...
class WPILIB_DLLEXPORT Rotation3d {
 public:
   ...
   */
  explicit constexpr Rotation3d(const Quaternion& q) { m_q = q.Normalize(); }
   ...
   */
  explicit constexpr Rotation3d(const Eigen::Vector3d& rvec)
   ...
   */
  explicit constexpr Rotation3d(const Eigen::Matrix3d& rotationMatrix) {

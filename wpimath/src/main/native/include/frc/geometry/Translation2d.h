...
template <>
struct from_json<frc::Translation2d> {
  template <auto Opts>
  static void op(frc::Translation2d& value, auto&&... args) {
    double x;
    double y;
    ...
    value = frc::Translation2d{units::meter_t{x}, units::meter_t{y}};
  }
};

template <>
struct to_json<frc::Translation2d> {
  template <auto Opts>
  static void op(const frc::Translation2d& value, auto&&... args) noexcept {

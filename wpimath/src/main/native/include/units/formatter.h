...
struct fmt::formatter<Unit, CharT, std::enable_if_t<units::is_unit_t<Unit>>> {
  ...
  auto format(const Unit& obj, FmtContext& ctx) const {
    ...
    using BaseUnits =
        units::unit<std::ratio<1>, typename Units::base_unit_type>;
    ...
    if constexpr (Units::base_unit_type::meter_ratio::num != 0 &&
      ...
      out = fmt::format_to(out, "^{}", Units::base_unit_type::meter_ratio::num);
    }
    if constexpr (Units::base_unit_type::meter_ratio::den != 1) {
      out = fmt::format_to(out, "/{}", Units::base_unit_type::meter_ratio::den);
    }
    ...
    if constexpr (Units::base_unit_type::second_ratio::num != 0 &&
      ...
      out =
          fmt::format_to(out, "^{}", Units::base_unit_type::second_ratio::num);
    }
    if constexpr (Units::base_unit_type::second_ratio::den != 1) {
      out =
          fmt::format_to(out, "/{}", Units::base_unit_type::second_ratio::den);
    }
    ...
    if constexpr (Units::base_unit_type::ampere_ratio::num != 0 &&
      ...
      out =
          fmt::format_to(out, "^{}", Units::base_unit_type::ampere_ratio::num);
    }
    if constexpr (Units::base_unit_type::ampere_ratio::den != 1) {
      out =
          fmt::format_to(out, "/{}", Units::base_unit_type::ampere_ratio::den);
    }
    ...
    if constexpr (Units::base_unit_type::kelvin_ratio::num != 0 &&
      ...
      out =
          fmt::format_to(out, "^{}", Units::base_unit_type::kelvin_ratio::num);
    }
    if constexpr (Units::base_unit_type::kelvin_ratio::den != 1) {
      out =
          fmt::format_to(out, "/{}", Units::base_unit_type::kelvin_ratio::den);
    }
    ...
    if constexpr (Units::base_unit_type::mole_ratio::num != 0 &&
      ...
      out = fmt::format_to(out, "^{}", Units::base_unit_type::mole_ratio::num);
    }
    if constexpr (Units::base_unit_type::mole_ratio::den != 1) {
      out = fmt::format_to(out, "/{}", Units::base_unit_type::mole_ratio::den);
    }
    ...
    if constexpr (Units::base_unit_type::candela_ratio::num != 0 &&
      ...
      out =
          fmt::format_to(out, "^{}", Units::base_unit_type::candela_ratio::num);
    }
    if constexpr (Units::base_unit_type::candela_ratio::den != 1) {
      out =
          fmt::format_to(out, "/{}", Units::base_unit_type::candela_ratio::den);
    }
    ...
    if constexpr (Units::base_unit_type::radian_ratio::num != 0 &&
      ...
      out =
          fmt::format_to(out, "^{}", Units::base_unit_type::radian_ratio::num);
    }
    if constexpr (Units::base_unit_type::radian_ratio::den != 1) {
      out =
          fmt::format_to(out, "/{}", Units::base_unit_type::radian_ratio::den);
    }
    ...
    if constexpr (Units::base_unit_type::byte_ratio::num != 0 &&
      ...
      out = fmt::format_to(out, "^{}", Units::base_unit_type::byte_ratio::num);
    }
    if constexpr (Units::base_unit_type::byte_ratio::den != 1) {
      out = fmt::format_to(out, "/{}", Units::base_unit_type::byte_ratio::den);
    }

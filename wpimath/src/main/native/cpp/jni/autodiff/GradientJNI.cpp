...
/*
 * Class:     edu_wpi_first_math_jni_autodiff_GradientJNI
 * Method:    destroy
 * Signature: (J)V
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_math_jni_autodiff_GradientJNI_destroy
...
Java_edu_wpi_first_math_jni_autodiff_GradientJNI_get
  (JNIEnv* env, jclass, jlong handle)
{}
 ...
 */
JNIEXPORT jobject JNICALL
Java_edu_wpi_first_math_jni_autodiff_GradientJNI_value
  (JNIEnv* env, jclass, jlong handle)
{}

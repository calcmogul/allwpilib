...
// and the derivative is computed with respect to each sub-expression recursively.
...
// denoted with a bar (w̄); it is a derivative of a chosen dependent variable with
// respect to a subexpression w: ∂y/∂w.
//

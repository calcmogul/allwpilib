...
struct GenericNumTraits {
  ...
  EIGEN_DEVICE_FUNC constexpr static inline Real epsilon() { return numext::numeric_limits<T>::epsilon(); }

  EIGEN_DEVICE_FUNC constexpr static inline int digits10() { return internal::default_digits10_impl<T>::run(); }

  EIGEN_DEVICE_FUNC constexpr static inline int max_digits10() { return internal::default_max_digits10_impl<T>::run(); }

  EIGEN_DEVICE_FUNC constexpr static inline int digits() { return internal::default_digits_impl<T>::run(); }

  EIGEN_DEVICE_FUNC constexpr static inline int min_exponent() { return numext::numeric_limits<T>::min_exponent; }

  EIGEN_DEVICE_FUNC constexpr static inline int max_exponent() { return numext::numeric_limits<T>::max_exponent; }

  EIGEN_DEVICE_FUNC constexpr static inline Real dummy_precision() {
    // make sure to override this for floating-point types
    return Real(0);
  }

  EIGEN_DEVICE_FUNC constexpr static inline T highest() { return (numext::numeric_limits<T>::max)(); }

  EIGEN_DEVICE_FUNC constexpr static inline T lowest() {
    return IsInteger ? (numext::numeric_limits<T>::min)() : static_cast<T>(-(numext::numeric_limits<T>::max)());
  }

  EIGEN_DEVICE_FUNC constexpr static inline T infinity() { return numext::numeric_limits<T>::infinity(); }

  EIGEN_DEVICE_FUNC constexpr static inline T quiet_NaN() { return numext::numeric_limits<T>::quiet_NaN(); }
};
...
struct NumTraits<float> : GenericNumTraits<float> {
  EIGEN_DEVICE_FUNC constexpr static inline float dummy_precision() { return 1e-5f; }
};

template <>
struct NumTraits<double> : GenericNumTraits<double> {
  EIGEN_DEVICE_FUNC constexpr static inline double dummy_precision() { return 1e-12; }
};
...
struct NumTraits<long double> : GenericNumTraits<long double> {
  EIGEN_DEVICE_FUNC constexpr static inline long double dummy_precision() { return static_cast<long double>(1e-15l); }

#if defined(EIGEN_ARCH_PPC) && (__LDBL_MANT_DIG__ == 106)
  // PowerPC double double causes issues with some values
  EIGEN_DEVICE_FUNC constexpr static inline long double epsilon() {
...
struct NumTraits<std::complex<Real_> > : GenericNumTraits<std::complex<Real_> > {
  ...
  EIGEN_DEVICE_FUNC constexpr static inline Real epsilon() { return NumTraits<Real>::epsilon(); }
  EIGEN_DEVICE_FUNC constexpr static inline Real dummy_precision() { return NumTraits<Real>::dummy_precision(); }
  EIGEN_DEVICE_FUNC constexpr static inline int digits10() { return NumTraits<Real>::digits10(); }
  EIGEN_DEVICE_FUNC constexpr static inline int max_digits10() { return NumTraits<Real>::max_digits10(); }
};
...
struct NumTraits<Array<Scalar, Rows, Cols, Options, MaxRows, MaxCols> > {
  ...
  EIGEN_DEVICE_FUNC constexpr static inline RealScalar epsilon() { return NumTraits<RealScalar>::epsilon(); }
  EIGEN_DEVICE_FUNC constexpr static inline RealScalar dummy_precision() {
    return NumTraits<RealScalar>::dummy_precision();
  }

  constexpr static inline int digits10() { return NumTraits<Scalar>::digits10(); }
  constexpr static inline int max_digits10() { return NumTraits<Scalar>::max_digits10(); }
};
...
struct NumTraits<std::string> : GenericNumTraits<std::string> {
  ...
  constexpr static inline int max_digits10() { return 0; }

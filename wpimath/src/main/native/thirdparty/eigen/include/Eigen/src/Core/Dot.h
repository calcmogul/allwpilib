...
struct lpNorm_selector {
  ...
  EIGEN_DEVICE_FUNC static inline constexpr RealScalar run(const MatrixBase<Derived>& m) {
    EIGEN_USING_STD(pow)
...
struct lpNorm_selector<Derived, 1> {
  EIGEN_DEVICE_FUNC static inline constexpr typename NumTraits<typename traits<Derived>::Scalar>::Real run(

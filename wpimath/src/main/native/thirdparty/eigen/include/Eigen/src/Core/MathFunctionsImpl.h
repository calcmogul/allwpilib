...
template <typename T>
EIGEN_DEVICE_FUNC constexpr std::complex<T> complex_sqrt(const std::complex<T>& z) {
...
template <typename T>
EIGEN_DEVICE_FUNC constexpr std::complex<T> complex_rsqrt(const std::complex<T>& z) {

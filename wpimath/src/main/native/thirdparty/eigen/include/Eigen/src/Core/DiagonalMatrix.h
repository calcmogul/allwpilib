...
class DiagonalBase : public EigenBase<Derived> {
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr inline Index rows() const { return diagonal().size(); }
  /** \returns the number of columns. */
  EIGEN_DEVICE_FUNC constexpr inline Index cols() const { return diagonal().size(); }
...
class DiagonalMatrix : public DiagonalBase<DiagonalMatrix<Scalar_, SizeAtCompileTime, MaxSizeAtCompileTime>> {
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC inline constexpr DiagonalMatrix() = default;

...
class NoAlias {
 public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr ExpressionType& operator=(const StorageBase<OtherDerived>& other) {
...
EIGEN_DEVICE_FUNC constexpr NoAlias<Derived, MatrixBase> MatrixBase<Derived>::noalias() {

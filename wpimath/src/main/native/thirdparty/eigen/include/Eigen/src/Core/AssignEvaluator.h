...
struct unaligned_dense_assignment_loop {
  ...
  template <typename Kernel>
  EIGEN_DEVICE_FUNC static EIGEN_STRONG_INLINE constexpr void run(Kernel&, Index, Index) {}
};
...
#if EIGEN_COMP_MSVC
  template <typename Kernel>
  static EIGEN_DONT_INLINE constexpr void run(Kernel& kernel, Index start, Index end)
#else
  template <typename Kernel>
...
class generic_dense_assignment_kernel {
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr DstEvaluatorType& dstEvaluator() EIGEN_NOEXCEPT { return m_dst; }
  EIGEN_DEVICE_FUNC constexpr const SrcEvaluatorType& srcEvaluator() const EIGEN_NOEXCEPT { return m_src; }
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr void call_dense_assignment_loop(
    DstXprType& dst,
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr void call_dense_assignment_loop(DstXprType& dst,

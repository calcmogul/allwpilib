...
#endif  // not EIGEN_PARSED_BY_DOXYGEN
{
 public:
  ...
  EIGEN_DEPRECATED constexpr const Derived& flagged() const {
    return derived();
  }
  ...
  EIGEN_DEVICE_FUNC constexpr static const ConstantReturnType Constant(Index rows, Index cols, const Scalar& value);
  EIGEN_DEVICE_FUNC constexpr static const ConstantReturnType Constant(Index size, const Scalar& value);
  EIGEN_DEVICE_FUNC constexpr static const ConstantReturnType Constant(const Scalar& value);

  EIGEN_DEPRECATED EIGEN_DEVICE_FUNC constexpr static const RandomAccessLinSpacedReturnType LinSpaced(
      Sequential_t, Index size, const Scalar& low, const Scalar& high);
  EIGEN_DEPRECATED EIGEN_DEVICE_FUNC constexpr static const RandomAccessLinSpacedReturnType LinSpaced(
      Sequential_t, const Scalar& low, const Scalar& high);

  EIGEN_DEVICE_FUNC constexpr static const RandomAccessLinSpacedReturnType LinSpaced(Index size, const Scalar& low,
                                                                                     const Scalar& high);
  EIGEN_DEVICE_FUNC constexpr static const RandomAccessLinSpacedReturnType LinSpaced(const Scalar& low,
                                                                                     const Scalar& high);

  EIGEN_DEVICE_FUNC constexpr static const RandomAccessEqualSpacedReturnType EqualSpaced(Index size, const Scalar& low,
                                                                                         const Scalar& step);
  EIGEN_DEVICE_FUNC constexpr static const RandomAccessEqualSpacedReturnType EqualSpaced(const Scalar& low,
                                                                                         const Scalar& step);

  template <typename CustomNullaryOp>
  EIGEN_DEVICE_FUNC constexpr static const CwiseNullaryOp<CustomNullaryOp, PlainObject> NullaryExpr(
  ...
  EIGEN_DEVICE_FUNC constexpr static const ConstantReturnType Zero(Index rows, Index cols);
  EIGEN_DEVICE_FUNC constexpr static const ConstantReturnType Zero(Index size);
  EIGEN_DEVICE_FUNC constexpr static const ConstantReturnType Zero();
  EIGEN_DEVICE_FUNC constexpr static const ConstantReturnType Ones(Index rows, Index cols);
  EIGEN_DEVICE_FUNC constexpr static const ConstantReturnType Ones(Index size);
  EIGEN_DEVICE_FUNC constexpr static const ConstantReturnType Ones();
   ...
   */
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr void swap(const DenseBase<OtherDerived>& other) {
   ...
   */
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr void swap(PlainObjectBase<OtherDerived>& other) {
    eigen_assert(rows() == other.rows() && cols() == other.cols());
    call_assignment(derived(), other.derived(), internal::swap_assign_op<Scalar>());
  }

  EIGEN_DEVICE_FUNC inline constexpr const NestByValue<Derived> nestByValue() const;
  EIGEN_DEVICE_FUNC inline constexpr const ForceAlignedAccess<Derived> forceAlignedAccess() const;
  EIGEN_DEVICE_FUNC inline constexpr ForceAlignedAccess<Derived> forceAlignedAccess();
  template <bool Enable>
  EIGEN_DEVICE_FUNC inline constexpr const std::conditional_t<Enable, ForceAlignedAccess<Derived>, Derived&>
  forceAlignedAccessIf() const;
  template <bool Enable>
  EIGEN_DEVICE_FUNC inline constexpr std::conditional_t<Enable, ForceAlignedAccess<Derived>, Derived&>
  ...
  EIGEN_DEVICE_FUNC inline constexpr ConstRowwiseReturnType rowwise() const {
    return ConstRowwiseReturnType(derived());
  }
  EIGEN_DEVICE_FUNC constexpr RowwiseReturnType rowwise();
   ...
   */
  EIGEN_DEVICE_FUNC inline constexpr ConstColwiseReturnType colwise() const {
    return ConstColwiseReturnType(derived());
  }
  EIGEN_DEVICE_FUNC constexpr ColwiseReturnType colwise();
  ...
  template <int p>
  constexpr RealScalar lpNorm() const;

  template <int RowFactor, int ColFactor>
  EIGEN_DEVICE_FUNC constexpr const Replicate<Derived, RowFactor, ColFactor> replicate() const;
  /**
   ...
   */
  // Code moved here due to a CUDA compiler bug
  EIGEN_DEVICE_FUNC constexpr const Replicate<Derived, Dynamic, Dynamic> replicate(Index rowFactor,
  ...
  EIGEN_DEVICE_FUNC constexpr ReverseReturnType reverse();
  /** This is the const version of reverse(). */
  // Code moved here due to a CUDA compiler bug
  EIGEN_DEVICE_FUNC constexpr ConstReverseReturnType reverse() const { return ConstReverseReturnType(derived()); }
  EIGEN_DEVICE_FUNC constexpr void reverseInPlace();
...
#undef EIGEN_DOC_UNARY_ADDONS
  ...
  EIGEN_DEVICE_FUNC inline constexpr void evalTo(Dest&) const {
 ...
 private:
  ...
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC constexpr explicit DenseBase(const DenseBase<OtherDerived>&);
};

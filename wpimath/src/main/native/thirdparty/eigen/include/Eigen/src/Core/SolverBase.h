...
struct solve_assertion {
  ...
  constexpr static void run(const Derived& solver, const Rhs& b) {
...
struct solve_assertion<Transpose<Derived>> {
  ...
  template <bool Transpose_, typename Rhs>
  constexpr static void run(const type& transpose, const Rhs& b) {
...
struct solve_assertion<CwiseUnaryOp<Eigen::internal::scalar_conjugate_op<Scalar>, const Transpose<Derived>>> {
  ...
  template <bool Transpose_, typename Rhs>
  constexpr static void run(const type& adjoint, const Rhs& b) {
...
class SolverBase : public EigenBase<Derived> {
 public:
   ...
   * \sa adjoint(), solve()
   */
  inline constexpr const ConstTransposeReturnType transpose() const { return ConstTransposeReturnType(derived()); }
   ...
   * \sa transpose(), solve()
   */
  inline constexpr const AdjointReturnType adjoint() const { return AdjointReturnType(derived().transpose()); }

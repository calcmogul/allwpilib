...
class indexed_based_stl_iterator_base {
 ...
 public:
  ...
  constexpr indexed_based_stl_iterator_base() EIGEN_NO_THROW : mp_xpr(0), m_index(0) {}
...
class indexed_based_stl_reverse_iterator_base {
 ...
 public:
  ...
  constexpr indexed_based_stl_reverse_iterator_base() : mp_xpr(0), m_index(0) {}
...
class pointer_based_stl_iterator {
 ...
 public:
  ...
  constexpr pointer_based_stl_iterator() EIGEN_NO_THROW : m_ptr(0) {}
...
class generic_randaccess_stl_iterator
 ...
 public:
  ...
  constexpr generic_randaccess_stl_iterator() : Base() {}
...
class subvector_stl_iterator : public indexed_based_stl_iterator_base<subvector_stl_iterator<XprType, Direction>> {
 ...
 public:
  ...
  constexpr subvector_stl_iterator() : Base() {}
...
class subvector_stl_reverse_iterator
 ...
 public:
  ...
  constexpr subvector_stl_reverse_iterator() : Base() {}

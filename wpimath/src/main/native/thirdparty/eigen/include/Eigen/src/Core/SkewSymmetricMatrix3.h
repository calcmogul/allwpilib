...
class SkewSymmetricBase : public EigenBase<Derived> {
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr inline Scalar determinant() const { return 0; }
  ...
  EIGEN_DEVICE_FUNC constexpr inline Index rows() const { return 3; }
  /** \returns the number of columns. */
  EIGEN_DEVICE_FUNC constexpr inline Index cols() const { return 3; }

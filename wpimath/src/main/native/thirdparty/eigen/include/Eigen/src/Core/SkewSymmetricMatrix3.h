...
class SkewSymmetricBase : public EigenBase<Derived> {
 public:
  ...
  EIGEN_DEVICE_FUNC inline constexpr Scalar determinant() const { return 0; }
  ...
  EIGEN_DEVICE_FUNC inline constexpr Index rows() const { return 3; }
  /** \returns the number of columns. */
  EIGEN_DEVICE_FUNC inline constexpr Index cols() const { return 3; }
...
class SkewSymmetricMatrix3 : public SkewSymmetricBase<SkewSymmetricMatrix3<Scalar_>> {
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC inline constexpr SkewSymmetricMatrix3() {}
  ...
  EIGEN_DEVICE_FUNC constexpr static InitializeReturnType Zero() {

...
struct EigenBase {
  ...
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR Derived& derived() { return *static_cast<Derived*>(this); }
  /** \returns a const reference to the derived object */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR const Derived& derived() const { return *static_cast<const Derived*>(this); }

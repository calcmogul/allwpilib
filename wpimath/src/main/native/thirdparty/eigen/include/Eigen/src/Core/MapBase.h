...
class MapBase<Derived, ReadOnlyAccessors> : public internal::dense_xpr_base<Derived>::type {
 public:
  ...
  EIGEN_DEVICE_FUNC inline constexpr Index rows() const EIGEN_NOEXCEPT { return m_rows.value(); }
  /** \copydoc DenseBase::cols() */
  EIGEN_DEVICE_FUNC inline constexpr Index cols() const EIGEN_NOEXCEPT { return m_cols.value(); }

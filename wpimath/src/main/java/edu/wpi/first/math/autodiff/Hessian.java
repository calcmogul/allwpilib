...
public class Hessian implements AutoCloseable {
  ...
  public Hessian(Variable variable, Variable wrt) {
    m_handle = HessianJNI.create(variable.getHandle(), new VariableMatrix(wrt));
  }
  ...
  public Hessian(Variable variable, VariableMatrix wrt) {
    m_handle = HessianJNI.create(variable.getHandle(), wrt);
  }
  ...
  public VariableMatrix get() {
    return HessianJNI.get(m_handle);
  }
  ...
  public DMatrixSparseCSC value() {
    return HessianJNI.value(m_handle);
  }
}

...
public class VariableJNI extends WPIMathJNI {
   ...
   */
  static native Variable times(long handle, long rhs);
   ...
   */
  static native Variable div(long handle, long rhs);
   ...
   */
  static native Variable plus(long handle, long rhs);
   ...
   */
  static native Variable minus(long handle, long rhs);
   ...
   * @param handle Variable handle.
   */
  static native Variable unaryMinus(long handle);

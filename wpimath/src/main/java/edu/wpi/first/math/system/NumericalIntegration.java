  ...
  public static <States extends Num, Inputs extends Num> Matrix<States, N1> rkf45(
    ...
    while (dtElapsed < dtSeconds) {
      do {
        ...
        var k1 = f.apply(x, u);
        var k2 = f.apply(x.plus(k1.times(B[0][0]).times(h)), u);
        var k3 = f.apply(x.plus(k1.times(B[1][0]).plus(k2.times(B[1][1])).times(h)), u);
        var k4 =
            f.apply(
                x.plus(k1.times(B[2][0]).plus(k2.times(B[2][1])).plus(k3.times(B[2][2])).times(h)),
                u);
        var k5 =
            f.apply(
                x.plus(

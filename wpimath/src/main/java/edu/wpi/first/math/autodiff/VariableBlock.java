...
public class VariableBlock {
 public:
   ...
   * Copy constructor.
   */
  VariableBlock(VariableBlock) = default;
   ...
   */
  VariableBlock<Mat>& operator=(VariableBlock values) {
    if (this == &values) {
      return *this;
    }
   ...
   */
  VariableBlock(VariableMatrix mat)
      : m_mat{&mat},
   ...
   */
  VariableBlock(VariableMatrix mat, int row_offset, int col_offset, int block_rows, int block_cols)
      : m_mat{&mat},
   ...
   */
  VariableBlock(VariableMatrix mat, Slice row_slice, int row_slice_length, Slice col_slice,

...
public class Jacobian implements AutoCloseable {
  ...
  public Jacobian(Variable variable, Variable wrt) {
    m_handle = JacobianJNI.createSM(variable.getHandle(), new VariableMatrix(wrt));
  }
  ...
  public Jacobian(VariableMatrix variables, VariableMatrix wrt) {
    m_handle = JacobianJNI.createMM(variables, wrt);
  }
  ...
  public Jacobian(VariableMatrix variables, VariableBlock wrt) {
    m_handle = JacobianJNI.createMM(variables, new VariableMatrix(wrt));
  }
  ...
  public VariableMatrix get() {
    return JacobianJNI.get(m_handle);
  }
  ...
  public DMatrixSparseCSC value() {
    return JacobianJNI.value(m_handle);
  }
}
